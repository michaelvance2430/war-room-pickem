...
| Ephemeral/staging SQL authoring | **No** in decision package · see **S2 design** `docs/D1C-S2-EPHEMERAL-SCHEMA-POLICY-DESIGN.md` (still no executable SQL unless separately authorized) |

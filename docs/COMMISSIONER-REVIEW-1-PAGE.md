# COMMISSIONER REVIEW 1 — PAGE SOURCE (unminified)

**Purpose:** Full source of the Commissioner route for ChatGPT product review.  
**Do not treat as design brief — inventory only.**  
**Generated:** 2026-08-03  
**Commit context:** main (local at generation)
...
- Route: `/commissioner`
- `page.tsx` dynamically imports `CommissionerClient` with `ssr: false`
- `loading.tsx` is the App Router loading UI for the segment
- `CommissionerClient.tsx` is the entire host desk (~5k lines)

---

### FILE: `src/app/commissioner/page.tsx`
...
### FILE: `src/app/commissioner/loading.tsx`
...
## CommissionerClient.tsx (FULL SOURCE)

...
| Universal/deep links | Integration ready | `warroom://`, Associated Domains, Team ID-backed AASA endpoint, and in-app routing are wired; deployment and physical-device proof remain |
...
6. Complete signing with enrolled team `XWW458P3J7`; the prepared
   Associated Domains/AASA handshake becomes live with the next website deployment.

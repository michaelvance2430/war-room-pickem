...
enum CheevoLore {
    ...
    private static let legendary: [String: String] = [
        ...
        "three_ring_circus": "Three legitimate rooms. Three engraved titles. The lucky-season defense has been dismissed for lack of evidence.",
        "five_star_dynasty": "Five official championships across real rooms. At this point the trophy case is no longer furniture. It is infrastructure.",
        "ten_room_terror": "Ten official league championships. Ten separate groups had every opportunity to stop this and collectively failed.",
    ...
    private static let rare: [String: String] = [
        ...
        "let_them_cook": "You handed the entire card to a chaos chef powered by random numbers and poor supervision. It seasoned nothing, respected no matchup, and doubled the consequences. Whatever comes out of that oven belongs to you.",

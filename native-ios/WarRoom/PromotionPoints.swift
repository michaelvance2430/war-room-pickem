...
enum CompetitiveLeagueBannerPolicy {
    static func copy(
        ...
        if !seasonIsFrozen && earlySeason && !forceDemo {
            ...
            if humans >= minimum {
                return CompetitiveLeagueBannerCopy(
                    ...
                    detail: "This room clears the four-player floor. Final active status begins after four scored cards; players must lock at least 75% of their eligible season.",
            ...
            return CompetitiveLeagueBannerCopy(
                ...
                detail: "Four human players are required before this room can enter the hardware track. Final active status begins after four scored cards and requires 75% participation.",
        ...
        if hardwareEligible {
            return CompetitiveLeagueBannerCopy(
                ...
                detail: seasonIsFrozen
                    ? "This season cleared the four-active-player requirement and can award permanent profile hardware."
        ...
        return CompetitiveLeagueBannerCopy(
            ...
            detail: earlySeason
                ? "Four active players are required. Active status begins after four scored cards, then requires picks in at least 75% of each player’s eligible season."

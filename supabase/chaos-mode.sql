-- Legacy is_chaos flag: regular-season AI catch-up card, 2x earned points.
...
comment on column public.picks.is_chaos is
  'True when player authorized a sealed regular-season catch-up weapon card (2x points earned, no negative scoring).';

-- Build 22 production repair: create_league_with_commissioner_seat must cast
-- the selected division label to the public.division enum. Without this cast,
-- every league creation fails before the commissioner membership is inserted.

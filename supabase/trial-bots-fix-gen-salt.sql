...
-- Then hard-refresh War Room → Add 50 trial bots

create extension if not exists pgcrypto with schema extensions;

-- Re-create seed function with extensions.crypt / extensions.gen_salt
...
begin
  ...
  return json_build_object('ok', true, 'added', v_added, 'totalBots', v_existing);
end;
$$;

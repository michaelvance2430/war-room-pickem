...
assert.match(ui, /JDAM complete impact file/);
assert.match(ui, /Damage file/);
assert.match(ui, /Human plan/);
assert.match(ui, /Computer result/);
assert.match(ui, /I HAVE REVIEWED THE DAMAGE/);
assert.match(ui, /COMPUTER BRACKET/);
assert.match(ui, /War Room JDAM Computer Bracket/);
assert.match(ui, /#WarRoom/);

...
const assertions = [
  ...
  [schema.includes("(1, 'Big Balls Ben')"), "Big Balls Ben must remain reserved as Founding Ten number 1"],
  [schema.includes("(2, 'Tbone Soulstache')"), "Tbone Soulstache must remain reserved as Founding Ten number 2"],

...
assert.deepEqual(new Set(buildNumbers), new Set(["31"]), "Every native target configuration must be stamped Build 31");
...
console.log("Native iOS release metadata PASS - Version 3.5, Build 31, bundle identity, signing team, push/deep-link entitlements, privacy manifest, encryption declaration, and app icon are present");

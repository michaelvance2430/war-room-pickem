...
assert.deepEqual(new Set(buildNumbers), new Set(["29"]), "Every native target configuration must be stamped Build 29");
...
console.log("Native iOS release metadata PASS - Version 3.5, Build 29, bundle identity, signing team, push/deep-link entitlements, privacy manifest, encryption declaration, and app icon are present");

...
export const ACT_THREE_CHAPTERS: Record<ActThreeSportId, ActThreeChapter> = {
  ...
  cfb: {
    ...
    game: {
      signature: "25 non-CFP bowls: Marquee 15 + Sicko 10, followed by the CFP",
      participation: "Every active player remains involved through bowl season",
      scoring: "Bowl Board and the full 12-team, 11-game CFP use separate scoring mechanics",
    ...
    foundryProof: [
      "CFP-host bowls are excluded and replaced by the next eligible non-CFP bowl",
      "Bowl Board contains exactly 15 Marquee and 10 Sicko games",
      "Exactly 100 bankroll points are allocated without duplication or overspend",
      "The 12-team, 11-game CFP bracket advances from real results without reseeding",

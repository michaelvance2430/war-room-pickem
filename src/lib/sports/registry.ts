...
const PACKS: SportPack[] = [
  ...
  },
  {
    ...
    emoji: "🌪️",
    blurb: "Preseason tournaments through March Madness. Full-season college hoops.",
    sortOrder: 6,
    status: "coming_soon",
    defaultSeasonWeeks: 21,
    defaultGamesPerWeek: 5,
    pridePickLabel: "National champ",
    rulesOneLiner: "Weekly cards · tournament windows · every March Madness game",
  },
  {
    id: "nascar",
    label: "NASCAR",

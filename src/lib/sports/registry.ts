...
const PACKS: SportPack[] = [
  ...
  },
  {
    ...
    shortLabel: "The Fieldhouse",
    emoji: "🏀",
    blurb:
      "Saturdays build the résumé. March destroys it. Under construction.",
    sortOrder: 3,
    status: "coming_soon",
    defaultSeasonWeeks: 18,
    defaultGamesPerWeek: 5,
    pridePickLabel: "National champion",
    rulesOneLiner: "Saturday slate · Tournament Takeovers · Field of 68",
  },
  {
    id: "soccer_wwc",

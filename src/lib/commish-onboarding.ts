...
export function buildInviteShareText(opts: {
  ...
  const byCfb: Record<InviteFlavor, (string | null)[]> = {
    ...
    xennial: [
      ...
      "",
      "War Room: CFB (college football) pick'em · confidence · Best Bet · props · Dispatch headlines · real standings.",
    ...
    chaos: [
      ...
      "Both are content. Both go in The Dispatch. Both will be brought up at Thanksgiving.",
      "",
    ...
    primetime: [
      ...
      "5 confidence picks · Best Bet · prop · Dispatch headlines.",
      "",
      linkBlock,
      codeLine,
      "",
  ...
  const byNfl: Record<InviteFlavor, (string | null)[]> = {
    ...
    xennial: [
      ...
      "We ported that energy to 2026 — without the weird apps that want your kidney data.",
      "",
      "War Room: NFL pick'em · confidence · Best Bet · props · Sunday Dispatch · real standings.",
      "Championship banner if you're good. Toilet Bowl if you're content.",
      "",
      linkBlock,
      codeLine,

...
export default function TermsPage() { return <PublicPolicyPage title="Terms of Use">
  ...
  <section><h2>Contact</h2><p>Questions or disputes should first be sent to <a className="text-primary underline" href="mailto:michaelvance2430@gmail.com">michaelvance2430@gmail.com</a> so they can be addressed directly.</p></section>
</PublicPolicyPage>; }

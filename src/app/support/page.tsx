...
export default function SupportPage() { return <PublicPolicyPage title="Support">
  <section><h2>Contact War Room</h2><p>Email <a className="text-primary underline" href="mailto:michaelvance2430@gmail.com?subject=War%20Room%20Support">michaelvance2430@gmail.com</a>. Include the screen you were on, what you expected, what happened, your device model, and—if relevant—the league name. Never send your password or authentication code.</p></section>

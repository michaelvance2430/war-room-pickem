...
export default function SupportPage() { return <PublicPolicyPage title="Support" updated="August 18, 2026">
  ...
  <section><h2>Account and privacy requests</h2><p>Permanent deletion is available inside the app at Account → Delete account. Use the support address for account access, correction, privacy questions, or help if deletion fails. Send the request from the email connected to your account so ownership can be verified.</p></section>
